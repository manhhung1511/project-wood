           ...
           <div className={cx("row")} style={{"margin-bottom": "60px"}}>
               <div className={cx("col-sm-7")}>
                   ...
                   <div className={cx("success_content-parent")}>
                       ...
                       <p className={cx("success_content-parent-content")}>{infor && infor.name}</p>
                   </div>
                   <div className={cx("success_content-parent")}>
                       <p className={cx("success_content-parent-title")}>Email: </p>
                       <p className={cx("success_content-parent-content")}>{infor && infor.email}</p>
                   </div>
                   <div className={cx("success_content-parent")}>
                       <p className={cx("success_content-parent-title")}>Địa chỉ nhận hàng: </p>
                       <p  className={cx("success_content-parent-content")}>{infor && address.address_detail} - {address.district} - {address.province}</p>
                   </div>
               </div>
