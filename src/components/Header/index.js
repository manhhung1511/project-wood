...
const Header = () => {
  ...
  <path d="M17.7528 16.5597L13.0415 11.8485C14.0303 10.6013 14.625 9.02759 14.625 7.3125C14.625 3.27392 11.3511 0 7.3125 0C3.27392 0 0 3.27392 0 7.3125C0 11.3511 3.27392 14.625 7.3125 14.625C9.02759 14.625 10.6013 14.0304 11.8484 13.0416L16.5597 17.7528C16.7245 17.9176 16.9403 18 17.1562 18C17.3721 18 17.588 17.9176 17.7528 17.7528C18.0824 17.4232 18.0824 16.8893 17.7528 16.5597ZM1.6875 7.3125C1.6875 4.21091 4.21084 1.6875 7.3125 1.6875C10.4142 1.6875 12.9375 4.21091 12.9375 7.3125C12.9375 10.4141 10.4142 12.9375 7.3125 12.9375C4.21084 12.9375 1.6875 10.4141 1.6875 7.3125Z" fill="#2E2E2E"/>
</svg>
                                    </Link>
                                </li>
                                <li className={cx("header_right-item")}>
                                ...
                                {user ? (
                                        ...
                                        <button type="button" onClick={handleLogin} style={{ "background": "none",
                                            "border": "none"}}>
  ...
  <path d="M10.9286 11.875H7.07143C3.16595 11.875 0 14.953 0 18.75C0 19.4403 0.575598 20 1.28571 20H16.7143C17.4244 20 18 19.4403 18 18.75C18 14.953 14.834 11.875 10.9286 11.875ZM1.96851 18.125C2.28596 15.6619 4.45339 13.75 7.07143 13.75H10.9286C13.5466 13.75 15.714 15.6619 16.0315 18.125H1.96851ZM9 10C11.8403 10 14.1429 7.76137 14.1429 5C14.1429 2.23855 11.8403 0 9 0C6.15966 0 3.85714 2.23855 3.85714 5C3.85714 7.76137 6.15966 10 9 10ZM9 1.875C10.7723 1.875 12.2143 3.27684 12.2143 5C12.2143 6.72309 10.7723 8.125 9 8.125C7.22768 8.125 5.78571 6.72309 5.78571 5C5.78571 3.27684 7.22768 1.875 9 1.875Z" fill="#2E2E2E"/>
            ...
            }
            {
                showRegister && (
                    <Overlay >
                        <Register onClose={handleRegisterClose} onLogin={handleLogin} onOtp={handleOtp} data={handleDataRegister}/>
                    </Overlay>
                )
            }

{
                showOtp && (
                    <Overlay >
                        <Otp onClose={handleOtpClose} onOtp={handleOtp} onLogin={handleLogin}/>
                    </Overlay>
                )
            }
